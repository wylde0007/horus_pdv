...
(
    ...
    ProductUnit VARCHAR(20) NOT NULL DEFAULT 'unidade',
...
ALTER TABLE Produtos ADD COLUMN IF NOT EXISTS ProductUnit VARCHAR(20) NOT NULL DEFAULT 'unidade';
ALTER TABLE Produtos ALTER COLUMN ProductImageUrl TYPE TEXT;
...
ALTER TABLE Empresas ADD COLUMN IF NOT EXISTS IsBranch BOOLEAN NOT NULL DEFAULT false;
...
ALTER TABLE Usuarios DROP CONSTRAINT IF EXISTS UQ_Usuarios_Cpf;

CREATE UNIQUE INDEX IF NOT EXISTS IX_Usuarios_Company_Cpf
    ON Usuarios (CompanyId, Cpf);
...
(
    ...
    PaymentType VARCHAR(500) NOT NULL DEFAULT '-',
